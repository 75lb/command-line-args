...
/**
@class
@classdesc A class encapsulating operations you can perform using the command-line arguments as input.
@param {module:definition[]} - An array of {@link module:definition} objects
