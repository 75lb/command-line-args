...
@param [argv=process.argv] {object} - Optional argv array, pass to override `process.argv`.
@returns {object}
@example
```js
{
...
/**
@param {object} data - options for template
@param {string} data.title - a title
@param {string} data.header - a header
@param {string} data.footer - a footer
@param {array} data.forms - the invocation forms
@returns {string}
*/
...
@property {function} type - an optional function (e.g. `Number` or a custom function) used to enforce type.
