...
runner$6.test('alias-cluster: two flags, one option, nothing set', function () {
  const optionDefinitions = [
...
runner$6.test('alias-cluster: three string options, partial', function () {
  const optionDefinitions = [
    { name: 'plugin', alias: 'p' },
    { name: 'depth', alias: 'd' },
    { name: 'file', alias: 'f' }
...
runner$7.test('alias-whitespace: with space after option', function () {
  const optionDefinitions = [
    { name: 'file', alias: 'f' }
  ];
  const argv = [ '-f', 'one' ];
...
runner$7.test('alias-whitespace: without space after option', function () {
  const optionDefinitions = [
    { name: 'file', alias: 'f' }
  ];
  const argv = [ '-fone' ];
...
runner$7.test('alias-whitespace: with space after option in cluster', function () {
  const optionDefinitions = [
    { name: 'file', alias: 'f' },
    { name: 'verbose', alias: 'v', type: Boolean }
  ];
...
runner$7.test('alias-whitespace: without space after option in cluster', function () {
  const optionDefinitions = [
    { name: 'file', alias: 'f' },
    { name: 'verbose', alias: 'v', type: Boolean }
  ];
...
runner$8.test('alias: one string alias', function () {
  const optionDefinitions = [
...
runner$8.test('alias: one boolean alias', function () {
  const optionDefinitions = [
...
runner$8.test('alias: one boolean, one string', function () {
  const optionDefinitions = [
    { name: 'verbose', alias: 'v', type: Boolean },
    { name: 'colour', alias: 'c' }
  ];
...
runner$9.test('ambiguous input: value looks like an option 1', function () {
  const optionDefinitions = [
    { name: 'colour', alias: 'c' }
  ];
  const argv = [ '-c', 'red' ];
...
runner$9.test('ambiguous input: value looks like an option 2', function () {
  const optionDefinitions = [
    { name: 'colour', alias: 'c' }
  ];
...
runner$9.test('ambiguous input: value looks like an option 3', function () {
  const optionDefinitions = [
    { name: 'colour', alias: 'c' }
  ];
  const argv = [ '--colour=--red' ];
...
runner$9.test('ambiguous input: value looks like an option 4', function () {
  const optionDefinitions = [
    { name: 'colour', alias: 'c' }
  ];
  const argv = [ '--colour=--red' ];
...
runner$a.test('bad-input: empty string', function () {
  const optionDefinitions = [
    { name: 'one' }
  ];
  const argv = [ '--one', '' ];
...
runner$a.test('bad-input: empty string, option cluster', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'o', type: Boolean },
    { name: 'two', alias: 't' }
  ];
...
runner$a.test('bad-input: empty string, --option=', function () {
  const optionDefinitions = [
    { name: 'one' }
  ];
  const argv = [ '--one=' ];
...
runner$a.test('bad-input: empty string unknown value', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean }
  ];
  const argv = [ '--one', '' ];
...
runner$a.test('bad-input: empty string added to unknown values', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean }
  ];
  const argv = [ '--one', '' ];
...
runner$b.test('bad-input: an unset option should not be defined', function () {
  const optionDefinitions = [
    { name: 'colour' }
  ];
  const argv = [];
...
runner$b.test('bad-input: missing option value should be null', function () {
  const optionDefinitions = [
    { name: 'colour' },
    { name: 'files' }
  ];
...
runner$b.test('bad-input: missing option value should be null 2', function () {
  const optionDefinitions = [
    { name: 'colour' },
    { name: 'files' }
  ];
...
runner$b.test('bad-input: handles arrays with relative paths', function () {
  const optionDefinitions = [
...
runner$b.test('bad-input: non-strings in argv', function () {
  const optionDefinitions = [
    { name: 'one', type: Number }
  ];
  const argv = [ '--one', 1 ];
...
runner$c.test('camel-case: regular', function () {
  const optionDefinitions = [
    { name: 'one-two' },
...
runner$c.test('camel-case: grouped', function () {
  const optionDefinitions = [
...
runner$c.test('camel-case: grouped with unknowns', function () {
  const optionDefinitions = [
    { name: 'one-one', group: 'a' },
    { name: 'two-two', group: 'a' },
    { name: 'three-three', group: 'b', type: Boolean },
...
runner$d.test('defaultOption: multiple string', function () {
  const optionDefinitions = [
...
runner$d.test('defaultOption: multiple-defaultOption values spread out', function () {
  const optionDefinitions = [
    { name: 'one' },
    { name: 'two' },
    { name: 'files', defaultOption: true, multiple: true }
...
runner$d.test('defaultOption: multiple-defaultOption values spread out 2', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean },
    { name: 'two' },
    { name: 'files', defaultOption: true, multiple: true }
...
runner$d.test('defaultOption: multiple with --option=value', function () {
  const definitions = [
    { name: 'files', defaultOption: true, multiple: true },
    { name: 'one', type: Boolean },
...
runner$e.test('defaultOption: after a boolean', function () {
  const definitions = [
    { name: 'one', type: Boolean },
    { name: 'two', defaultOption: true }
  ];
...
runner$e.test('defaultOption with value equal to defaultValue', function () {
  const definitions = [
...
runner$e.test('string defaultOption can be set by argv once', function () {
  const definitions = [
    { name: 'file', defaultOption: true, defaultValue: 'file1' }
  ];
...
runner$e.test('string defaultOption cannot be set by argv twice', function () {
  const definitions = [
    { name: 'file', defaultOption: true, defaultValue: 'file1' }
  ];
...
runner$f.test('defaultOption: multiple string', function () {
  const optionDefinitions = [
    { name: 'files', defaultOption: true, multiple: true }
  ];
  const argv = [ 'file1', 'file2' ];
...
runner$f.test('defaultOption: multiple-defaultOption values spread out', function () {
  const optionDefinitions = [
    { name: 'one' },
    { name: 'two' },
    { name: 'files', defaultOption: true, multiple: true }
...
runner$f.test('defaultOption: multiple-defaultOption values spread out 2', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean },
    { name: 'two' },
    { name: 'files', defaultOption: true, multiple: true }
...
runner$f.test('defaultOption: multiple with --option=value', function () {
  const definitions = [
    { name: 'files', defaultOption: true, multiple: true },
    { name: 'one', type: Boolean },
    { name: 'two', alias: 't', defaultValue: 2 }
...
runner$g.test('default value', function () {
  const optionDefinitions = [
    { name: 'one' },
...
runner$g.test('default value 2', function () {
  const optionDefinitions = [
    { name: 'two', defaultValue: 'two' }
  ];
  const argv = [];
...
runner$g.test('default value 3', function () {
  const optionDefinitions = [
    { name: 'two', defaultValue: 'two' }
  ];
  const argv = [ '--two', 'zwei' ];
...
runner$g.test('default value 4', function () {
  const optionDefinitions = [
...
runner$g.test('default value 5', function () {
  const optionDefinitions = [
    { name: 'two', multiple: true, defaultValue: ['two', 'zwei'] }
  ];
  const argv = [];
...
runner$g.test('default value: array as defaultOption', function () {
  const optionDefinitions = [
...
runner$g.test('default value: falsy default values', function () {
  const optionDefinitions = [
...
runner$g.test('default value: is arrayifed if multiple set', function () {
  const optionDefinitions = [
...
runner$g.test('default value: combined with defaultOption', function () {
  const optionDefinitions = [
...
runner$g.test('default value: combined with multiple and defaultOption', function () {
  const optionDefinitions = [
...
runner$g.test('default value: array default combined with multiple and defaultOption', function () {
  const optionDefinitions = [
    { name: 'path', multiple: true, defaultOption: true, defaultValue: [ './' ] }
  ];
...
runner$i.test('detect process.execArgv: should automatically remove first argv items', function () {
...
runner$j.test('exceptions-already-set: long option', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean }
  ];
  const argv = [ '--one', '--one' ];
...
runner$j.test('exceptions-already-set: short option', function () {
  const optionDefinitions = [
...
runner$j.test('exceptions-already-set: --option=value', function () {
  const optionDefinitions = [
    { name: 'one' }
  ];
...
runner$j.test('exceptions-already-set: combined short option', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean, alias: 'o' }
  ];
  const argv = [ '-oo' ];
...
runner$j.test('exceptions-already-set: alias then long', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'o' }
  ];
...
runner$j.test('exceptions-already-set: alias then --option=value', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'o' }
  ];
  const argv = [ '-o', '1', '--one=1' ];
...
runner$k.test('err-invalid-definition: throws when no definition.name specified', function () {
  const optionDefinitions = [
    { something: 'one' },
    { something: 'two' }
  ];
...
runner$k.test('err-invalid-definition: throws if dev set a numeric alias', function () {
  const optionDefinitions = [
...
runner$k.test('err-invalid-definition: throws if dev set an alias of "-"', function () {
  const optionDefinitions = [
    { name: 'colours', alias: '-' }
  ];
  const argv = [ '--colours', 'red' ];
...
runner$k.test('err-invalid-definition: multi-character alias', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'aa' }
  ];
  const argv = [ '--one', 'red' ];
...
runner$k.test('err-invalid-definition: invalid type values 1', function () {
...
runner$k.test('err-invalid-definition: invalid type values 2', function () {
  const argv = [ '--one', 'something' ];
  a.throws(
...
runner$k.test('err-invalid-definition: invalid type values 3', function () {
  const argv = [ '--one', 'something' ];
  a.throws(
...
runner$k.test('err-invalid-definition: invalid type values 4', function () {
  const argv = [ '--one', 'something' ];
  a.doesNotThrow(function () {
...
runner$k.test('err-invalid-definition: duplicate name', function () {
  const optionDefinitions = [
    { name: 'colours' },
    { name: 'colours' }
  ];
...
runner$k.test('err-invalid-definition: duplicate alias', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'a' },
    { name: 'two', alias: 'a' }
  ];
...
runner$k.test('err-invalid-definition: multiple defaultOption', function () {
  const optionDefinitions = [
    { name: 'one', defaultOption: true },
    { name: 'two', defaultOption: true }
  ];
...
runner$k.test('err-invalid-defaultOption: defaultOption on a Boolean type', function () {
  const optionDefinitions = [
...
runner$l.test('exceptions-unknowns: unknown option', function () {
  const optionDefinitions = [
    { name: 'one', type: Number }
  ];
  a.throws(
...
runner$l.test('exceptions-unknowns: 1 unknown option, 1 unknown value', function () {
  const optionDefinitions = [
    { name: 'one', type: Number }
  ];
  a.throws(
...
runner$l.test('exceptions-unknowns: unknown alias', function () {
  const optionDefinitions = [
    { name: 'one', type: Number }
  ];
  a.throws(
...
runner$l.test('exceptions-unknowns: unknown combined aliases', function () {
  const optionDefinitions = [
    { name: 'one', type: Number }
  ];
  const argv = [ '-sdf' ];
...
runner$l.test('exceptions-unknowns: unknown value', function () {
  const optionDefinitions = [
    { name: 'one' }
  ];
...
runner$l.test('exceptions-unknowns: unknown value with singular defaultOption', function () {
  const optionDefinitions = [
    { name: 'one', defaultOption: true }
  ];
...
runner$l.test('exceptions-unknowns: no unknown value exception with multiple defaultOption', function () {
  const optionDefinitions = [
...
runner$l.test('exceptions-unknowns: non-multiple defaultOption should take first value 2', function () {
  const optionDefinitions = [
...
runner$m.test('groups: multiple and _none', function () {
  const definitions = [
    { name: 'one', group: ['a', 'f'] },
    { name: 'two', group: ['a', 'g'] },
    { name: 'three' }
...
runner$m.test('groups: nothing set', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three', group: 'b' }
...
runner$m.test('groups: nothing set with one ungrouped', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three' }
...
runner$m.test('groups: two ungrouped, one set', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three' },
...
runner$m.test('groups: two ungrouped, both set', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three' },
...
runner$m.test('groups: with partial', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three', group: 'b' }
...
runner$m.test('partial: with partial, multiple groups and _none', function () {
  const definitions = [
    { name: 'one', group: ['a', 'f'] },
    { name: 'two', group: ['a', 'g'] },
    { name: 'three' }
...
runner$n.test('lazy multiple: string', function () {
...
runner$n.test('lazy multiple: string unset with defaultValue', function () {
  const optionDefinitions = [
...
runner$n.test('lazy multiple: string, --option=value', function () {
  const optionDefinitions = [
    { name: 'one', lazyMultiple: true }
  ];
  const argv = [ '--one=1', '--one=2' ];
...
runner$n.test('lazy multiple: string, --option=value mix', function () {
  const optionDefinitions = [
    { name: 'one', lazyMultiple: true }
  ];
...
runner$n.test('lazy multiple: string, defaultOption', function () {
  const optionDefinitions = [
...
runner$n.test('lazy multiple: greedy style, string', function () {
  const optionDefinitions = [
    { name: 'one', lazyMultiple: true }
  ];
  const argv = [ '--one', '1', '2' ];
...
runner$n.test('lazy multiple: greedy style, string, --option=value', function () {
  const optionDefinitions = [
    { name: 'one', lazyMultiple: true }
  ];
  const argv = [ '--one=1', '--one=2' ];
...
runner$n.test('lazy multiple: greedy style, string, --option=value mix', function () {
  const optionDefinitions = [
    { name: 'one', lazyMultiple: true }
  ];
...
runner$o.test('multiple: empty argv', function () {
  const optionDefinitions = [
    { name: 'one', multiple: true }
  ];
  const argv = [];
...
runner$o.test('multiple: boolean, empty argv', function () {
  const optionDefinitions = [
...
runner$o.test('multiple: string unset with defaultValue', function () {
  const optionDefinitions = [
...
runner$o.test('multiple: string', function () {
  const optionDefinitions = [
    { name: 'one', multiple: true }
  ];
  const argv = [ '--one', '1', '2' ];
...
runner$o.test('multiple: string, --option=value', function () {
  const optionDefinitions = [
    { name: 'one', multiple: true }
  ];
  const argv = [ '--one=1', '--one=2' ];
...
runner$o.test('multiple: string, --option=value mix', function () {
  const optionDefinitions = [
    { name: 'one', multiple: true }
  ];
  const argv = [ '--one=1', '--one=2', '3' ];
...
runner$o.test('multiple: string, defaultOption', function () {
  const optionDefinitions = [
...
runner$p.test('name-unicode: unicode names and aliases are permitted', function () {
  const optionDefinitions = [
    { name: 'один' },
    { name: '两' },
    { name: 'три', alias: 'т' }
...
runner$p.test('name-alias-mix: one of each', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'o' },
    { name: 'two', alias: 't' },
    { name: 'three', alias: 'h' },
...
runner$q.test('name-unicode: unicode names and aliases are permitted', function () {
  const optionDefinitions = [
    { name: 'один' },
    { name: '两' },
    { name: 'три', alias: 'т' }
...
runner$r.test('name-unicode: unicode names and aliases are permitted', function () {
  const optionDefinitions = [
    { name: 'один' },
    { name: '两' },
    { name: 'три', alias: 'т' }
...
runner$r.test('name-alias-mix: one of each', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'o' },
    { name: 'two', alias: 't' },
    { name: 'three', alias: 'h' },
...
runner$s.test('--option=value notation: two plus a regular notation', function () {
  const optionDefinitions = [
    { name: 'one' },
    { name: 'two' },
    { name: 'three' }
...
runner$s.test('--option=value notation: value contains "="', function () {
  const optionDefinitions = [
    { name: 'url' },
    { name: 'two' },
    { name: 'three' }
...
runner$t.test('camel-case: regular', function () {
  const optionDefinitions = [
    { name: 'one-two' },
    { name: 'three', type: Boolean }
  ];
...
runner$t.test('camel-case: grouped', function () {
  const optionDefinitions = [
    { name: 'one-one', group: 'a' },
    { name: 'two-two', group: 'a' },
    { name: 'three-three', group: 'b', type: Boolean },
...
runner$t.test('camel-case: grouped with unknowns', function () {
  const optionDefinitions = [
    { name: 'one-one', group: 'a' },
    { name: 'two-two', group: 'a' },
    { name: 'three-three', group: 'b', type: Boolean },
...
runner$u.test('groups: multiple and _none', function () {
  const definitions = [
    { name: 'one', group: ['a', 'f'] },
    { name: 'two', group: ['a', 'g'] },
    { name: 'three' }
...
runner$u.test('groups: nothing set', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three', group: 'b' }
...
runner$u.test('groups: nothing set with one ungrouped', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three' }
...
runner$u.test('groups: two ungrouped, one set', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three' },
...
runner$u.test('groups: two ungrouped, both set', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three' },
...
runner$u.test('groups: with partial', function () {
  const definitions = [
    { name: 'one', group: 'a' },
    { name: 'two', group: 'a' },
    { name: 'three', group: 'b' }
...
runner$u.test('partial: with partial, multiple groups and _none', function () {
  const definitions = [
    { name: 'one', group: ['a', 'f'] },
    { name: 'two', group: ['a', 'g'] },
    { name: 'three' }
...
runner$v.test('partial: simple', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean }
  ];
...
runner$v.test('partial: defaultOption', function () {
  const optionDefinitions = [
    { name: 'files', defaultOption: true, multiple: true }
  ];
...
runner$v.test('defaultOption: floating args present but no defaultOption', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean }
  ];
...
runner$v.test('partial: combined short option, both unknown', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'o' },
    { name: 'two', alias: 't' }
  ];
...
runner$v.test('partial: combined short option, one known, one unknown', function () {
  const optionDefinitions = [
    { name: 'one', alias: 'o' },
    { name: 'two', alias: 't' }
  ];
...
runner$v.test('partial: defaultOption with --option=value and combined short options', function () {
  const optionDefinitions = [
    { name: 'files', defaultOption: true, multiple: true },
    { name: 'one', type: Boolean },
    { name: 'two', alias: 't', defaultValue: 2 }
...
runner$v.test('partial: defaultOption with value equal to defaultValue', function () {
  const optionDefinitions = [
    { name: 'file', defaultOption: true, defaultValue: 'file1' }
  ];
...
runner$v.test('partial: string defaultOption can be set by argv once', function () {
  const optionDefinitions = [
    { name: 'file', defaultOption: true, defaultValue: 'file1' }
  ];
...
runner$v.test('partial: string defaultOption can not be set by argv twice', function () {
  const optionDefinitions = [
    { name: 'file', defaultOption: true, defaultValue: 'file1' }
  ];
...
runner$v.test('partial: defaultOption with value equal to defaultValue 3', function () {
  const optionDefinitions = [
    { name: 'file', defaultOption: true, defaultValue: 'file1' }
  ];
...
runner$v.test('partial: multiple', function () {
  const optionDefinitions = [
...
runner$v.test('unknown options: rejected defaultOption values end up in _unknown', function () {
  const optionDefinitions = [
    { name: 'foo' },
    { name: 'verbose', alias: 'v', type: Boolean },
...
runner$v.test('partial: defaultOption with --option=value notation', function () {
  const optionDefinitions = [
    { name: 'files', multiple: true, defaultOption: true }
  ];
...
runner$v.test('partial: defaultOption with --option=value notation 2', function () {
  const optionDefinitions = [
    { name: 'files', multiple: true, defaultOption: true }
  ];
...
runner$v.test('partial: defaultOption with --option=value notation 3', function () {
  const optionDefinitions = [
    { name: 'files', multiple: true, defaultOption: true }
  ];
...
runner$v.test('partial: mulitple unknowns with same name', function () {
  const optionDefinitions = [
    { name: 'file' }
  ];
...
runner$v.test('defaultOption: single string', function () {
  const optionDefinitions = [
...
const runner$w = new TestRunner();

runner$w.test('stopAtFirstUnknown', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean },
    { name: 'two', type: Boolean }
  ];
...
runner$w.test('stopAtFirstUnknown: with a singlular defaultOption', function () {
  const optionDefinitions = [
    { name: 'one', defaultOption: true },
    { name: 'two' }
  ];
...
runner$w.test('stopAtFirstUnknown: with a singlular defaultOption and partial', function () {
  const optionDefinitions = [
    { name: 'one', defaultOption: true },
    { name: 'two' }
  ];
...
const runner$x = new TestRunner();

runner$x.test('type-boolean: simple', function () {
  const optionDefinitions = [
    { name: 'one', type: Boolean }
  ];
...
/* test in contexts which override the standard global Boolean constructor */
runner$x.test('type-boolean: global Boolean overridden', function () {
  function Boolean () {
...
runner$x.test('type-boolean-multiple: 1', function () {
  const optionDefinitions = [
...
const runner$y = new TestRunner();

runner$y.test('name: no argv values', function () {
  const optionDefinitions = [
    { name: 'one' },
    { name: 'two' }
  ];
...
runner$y.test('name: just names, no values', function () {
  const optionDefinitions = [
    { name: 'one' },
    { name: 'two' }
  ];
...
runner$y.test('name: just names, one value, one unpassed value', function () {
  const optionDefinitions = [
    { name: 'one' },
    { name: 'two' }
  ];
...
runner$y.test('name: just names, two values', function () {
  const optionDefinitions = [
    { name: 'one' },
    { name: 'two' }
  ];
...
const runner$z = new TestRunner();

runner$z.test('type-number: different values', function () {
  const optionDefinitions = [
    { name: 'one', type: Number }
  ];
  a.deepStrictEqual(
...
runner$z.test('number multiple: 1', function () {
  const optionDefinitions = [
...
runner$z.test('number multiple: 2', function () {
  const optionDefinitions = [
    { name: 'array', type: Number, multiple: true }
  ];
...
runner$A.test('type-other: different values', function () {
  const definitions = [
    {
      name: 'file',
      type: function (file) {
...
runner$A.test('type-other: broken custom type function', function () {
  const definitions = [
    {
      name: 'file',
      type: function (file) {
...
runner$A.test('type-other-multiple: different values', function () {
  const definitions = [
    {
      name: 'file',
      multiple: true,
...
runner$B.test('type-string: different values', function () {
  const optionDefinitions = [
